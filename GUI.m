...
% Last Modified by GUIDE v2.5 20-Dec-2014 12:29:33
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% set(handles.edit1, 'String', 'F:\Dropbox\WORKSPACE\HCI Project\test.png');
wanted=get(handles.edit1, 'String');
Class_No=Search_f(wanted);
ShowResult_f(Class_No);
guidata(hObject, handles);
